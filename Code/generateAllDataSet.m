...
%for problem_type = [string('concave_triangular'), string('concave_invertedtriangular')]
%for problem_type = [string('linear_invertedtriangular'), string('linear_triangular')]
for problem_type = [string('convex_invertedtriangular')]
%for problem_type = [string('convex_triangular')]
